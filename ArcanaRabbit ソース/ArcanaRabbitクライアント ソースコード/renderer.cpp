...
BLEND_MODE				g_BlendStateParam = BLEND_MODE_ALPHABLEND;
...
void Renderer::Init()
{
	...
	samplerDesc.Filter = D3D11_FILTER_MIN_MAG_POINT_MIP_LINEAR;//こいつ
...
void Renderer::Begin()
{
	//float clearColor[4] = { 0.6274f, 0.84313f, 0.93725f, 1.0f };
