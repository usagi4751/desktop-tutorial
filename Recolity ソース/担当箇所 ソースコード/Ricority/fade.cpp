...
void DrawFade(void)
{
	...
	UI ui = { {SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2}, {SCREEN_WIDTH, SCREEN_HEIGHT}, {0.0f, 0.0f}, {1.0f, 1.0f}, g_Color };
	DrawScreen(ui, RefImageMaterial().m_Fade);
}
