...
//VH	: UV値高さ
//color : 頂点の色（RGBA）
void DrawSpriteColor4(int texNo, float X, float Y, float Width, float Height,
	D3DXCOLOR coler1, D3DXCOLOR coler2, D3DXCOLOR coler3, D3DXCOLOR coler4)
{
	...
	// 頂点０番（左上の頂点）
	vertex[0].Position = D3DXVECTOR3(X - hw, Y - hh, 0.0f);
	vertex[0].Diffuse = coler1;
	vertex[0].TexCoord = D3DXVECTOR2(0.0f, 0.0f);

	// 頂点１番（右上の頂点）
	vertex[1].Position = D3DXVECTOR3(X + hw, Y - hh, 0.0f);
	vertex[1].Diffuse = coler2;
	vertex[1].TexCoord = D3DXVECTOR2(1.0f, 0.0f);

	// 頂点２番（左下の頂点）
	vertex[2].Position = D3DXVECTOR3(X - hw, Y + hh, 0.0f);
	vertex[2].Diffuse = coler3;
	vertex[2].TexCoord = D3DXVECTOR2(0.0f, 1.0f);

	// 頂点３番（右下の頂点）
	vertex[3].Position = D3DXVECTOR3(X + hw, Y + hh, 0.0f);
	vertex[3].Diffuse = coler4;
	...
	D3DXCOLOR coler)
{
	...
	// 頂点０番（左上の頂点）
	vertex[0].Position = D3DXVECTOR3(X - hw, Y - hh, 0.0f);
	vertex[0].Diffuse = coler;
	vertex[0].TexCoord = D3DXVECTOR2(U, V);

	// 頂点１番（右上の頂点）
	vertex[1].Position = D3DXVECTOR3(X + hw, Y - hh, 0.0f);
	vertex[1].Diffuse = coler;
	vertex[1].TexCoord = D3DXVECTOR2(U + UW, V);

	// 頂点２番（左下の頂点）
	vertex[2].Position = D3DXVECTOR3(X - hw, Y + hh, 0.0f);
	vertex[2].Diffuse = coler;
	vertex[2].TexCoord = D3DXVECTOR2(U, V + VH);

	// 頂点３番（右下の頂点）
	vertex[3].Position = D3DXVECTOR3(X + hw, Y + hh, 0.0f);
	vertex[3].Diffuse = coler;
	vertex[3].TexCoord = D3DXVECTOR2(U + UW, V + VH);
