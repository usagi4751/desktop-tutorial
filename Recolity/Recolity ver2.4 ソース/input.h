...
BOOL IsMouseSide4Pressed(void);		//	4サイドボタン
BOOL IsMouseSide4Triggered(void);	//	4サイドボタン
BOOL IsMouseSide5Pressed(void);		//	5サイドボタン
BOOL IsMouseSide5Triggered(void);	//	5サイドボタン
