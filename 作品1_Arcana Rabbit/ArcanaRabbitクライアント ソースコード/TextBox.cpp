...
void TextBox::Init()
{
	...
	*m_Text = "aaa";
	...
	m_UI_LogText.Link(Draw2D_Manager::AddTEXT());
	m_UI_LogText.SetScale(25);
	m_UI_LogText.SetRect({0,0,1920,1080});
}
...
void TextBox::Update()
{
	m_UI_LogText.SetText(Manager::GetUdpManager()->GetChatData());
	if (m_IsOpenflug) {
