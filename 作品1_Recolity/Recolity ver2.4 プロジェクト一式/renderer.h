...
enum FONT_WIDTH
{
	EFW_DONTCARE = FW_DONTCARE,
	EFW_THIN = FW_THIN,
	EFW_EXTRALIGHT = FW_EXTRALIGHT,
	EFW_LIGHT = FW_LIGHT,
	EFW_NORMAL = FW_NORMAL,
	EFW_MEDIUM = FW_MEDIUM,
	EFW_SEMIBOLD = FW_SEMIBOLD,
	EFW_BOLD = FW_BOLD,
	EFW_EXTRABOLD = FW_EXTRABOLD,
	EFW_HEAVY = FW_HEAVY
};
...
IDXGISwapChain* GetSwapChainrend();
...
//=============================================================================
// カスタムテキスト出力
// ss		:文字列(数字でもなんでも入れられる)
// x		:x座標
// y		:y座標
// color	:文字カラー
// back		:背景(true:透明 false:不透明)
//=============================================================================
void CustomText(std::stringstream& ss, int x, int y, D3DXVECTOR3 color, bool back);
