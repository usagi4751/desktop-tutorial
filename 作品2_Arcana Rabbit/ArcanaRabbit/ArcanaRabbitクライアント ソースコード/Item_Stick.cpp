...
void Item_Stick::GetItemName(Item itemData, std::string* itemname, std::string* itemdescription, std::string* skillname, std::string* skilldescription)
{
	*itemname = "棒";
	*itemdescription = "様々なクラフトに使うアイテム\n\n";

}
int Item_Stick::GetIcon()
{
	return GetImage().m_ItemTex_Stick;
}
